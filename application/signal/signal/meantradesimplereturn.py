...
from generated.type.signal.msg.meantradesimplereturn import MeanTradeSimpleReturnMsg
from generated.type.signal.msg.subscribemeantradesimplereturn import SubscribeMeanTradeSimpleReturnMsg


class MeanTradeSimpleReturnSignal(Signal):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            signal_type=SignalTypeEnum.MEAN_SIMPLE_RETURN, 
        )
    ...
    def subscribe_to_messages(self) -> None:
        super().subscription_manager.subscribe(
            type=SubscribeMeanTradeSimpleReturnMsg, callback=self._handle_subscribe_mean_trade_simple_return,
        )
    
    def _handle_subscribe_mean_trade_simple_return(self, msg: SubscribeMeanTradeSimpleReturnMsg) -> None:
    ...
    def evaluate(self, subscription: SignalSubscription, memo: Memo[SignalSubscription, SignalMemoItem]) -> None:
        ...
        simple_return = trade_ledger.mean_simple_return(window_nanos=window_nanos)
        ...
        with super().message_sender.create(type=MeanTradeSimpleReturnMsg) as mean_trade_simple_return_msg:
            mean_trade_simple_return_msg.signal_id = subscription.signal_id
            mean_trade_simple_return_msg.last_trade_time_nanos = trade_ledger.latest_time
            mean_trade_simple_return_msg.simple_return = simple_return
            mean_trade_simple_return_msg.gradient = signal_memo.gradient() or DEFAULT_GRADIENT
            super().message_sender.send(msg=mean_trade_simple_return_msg)