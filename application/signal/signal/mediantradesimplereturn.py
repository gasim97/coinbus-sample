...
from generated.type.signal.msg.mediantradesimplereturn import MedianTradeSimpleReturnMsg
from generated.type.signal.msg.subscribemediantradesimplereturn import SubscribeMedianTradeSimpleReturnMsg


class MedianTradeSimpleReturnSignal(Signal):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            signal_type=SignalTypeEnum.MEDIAN_SIMPLE_RETURN, 
        )
    ...
    def subscribe_to_messages(self) -> None:
        super().subscription_manager.subscribe(
            type=SubscribeMedianTradeSimpleReturnMsg, callback=self._handle_subscribe_median_trade_simple_return,
        )
    
    def _handle_subscribe_median_trade_simple_return(self, msg: SubscribeMedianTradeSimpleReturnMsg) -> None:
    ...
    def evaluate(self, subscription: SignalSubscription, memo: Memo[SignalSubscription, SignalMemoItem]) -> None:
        ...
        simple_return = trade_ledger.median_simple_return(window_nanos=window_nanos)
        ...
        with super().message_sender.create(type=MedianTradeSimpleReturnMsg) as median_trade_simple_return_msg:
            median_trade_simple_return_msg.signal_id = subscription.signal_id
            median_trade_simple_return_msg.last_trade_time_nanos = trade_ledger.latest_time
            median_trade_simple_return_msg.simple_return = simple_return
            median_trade_simple_return_msg.gradient = signal_memo.gradient() or DEFAULT_GRADIENT
            super().message_sender.send(msg=median_trade_simple_return_msg)