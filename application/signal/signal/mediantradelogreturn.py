...
from generated.type.signal.msg.mediantradelogreturn import MedianTradeLogReturnMsg
from generated.type.signal.msg.subscribemediantradelogreturn import SubscribeMedianTradeLogReturnMsg


class MedianTradeLogReturnSignal(Signal):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            signal_type=SignalTypeEnum.MEDIAN_LOG_RETURN, 
        )
    ...
    def subscribe_to_messages(self) -> None:
        super().subscription_manager.subscribe(
            type=SubscribeMedianTradeLogReturnMsg, callback=self._handle_subscribe_median_trade_log_return,
        )
    
    def _handle_subscribe_median_trade_log_return(self, msg: SubscribeMedianTradeLogReturnMsg) -> None:
    ...
    def evaluate(self, subscription: SignalSubscription, memo: Memo[SignalSubscription, SignalMemoItem]) -> None:
        ...
        log_return = trade_ledger.median_log_return(window_nanos=window_nanos)
        ...
        with super().message_sender.create(type=MedianTradeLogReturnMsg) as median_trade_log_return_msg:
            median_trade_log_return_msg.signal_id = subscription.signal_id
            median_trade_log_return_msg.last_trade_time_nanos = trade_ledger.latest_time
            median_trade_log_return_msg.log_return = log_return
            median_trade_log_return_msg.gradient = signal_memo.gradient() or DEFAULT_GRADIENT
            super().message_sender.send(msg=median_trade_log_return_msg)