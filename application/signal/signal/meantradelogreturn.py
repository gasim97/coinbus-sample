...
from generated.type.signal.msg.meantradelogreturn import MeanTradeLogReturnMsg
from generated.type.signal.msg.subscribemeantradelogreturn import SubscribeMeanTradeLogReturnMsg


class MeanTradeLogReturnSignal(Signal):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            signal_type=SignalTypeEnum.MEAN_LOG_RETURN, 
        )
    ...
    def subscribe_to_messages(self) -> None:
        super().subscription_manager.subscribe(
            type=SubscribeMeanTradeLogReturnMsg, callback=self._handle_subscribe_mean_trade_log_return,
        )
    
    def _handle_subscribe_mean_trade_log_return(self, msg: SubscribeMeanTradeLogReturnMsg) -> None:
    ...
    def evaluate(self, subscription: SignalSubscription, memo: Memo[SignalSubscription, SignalMemoItem]) -> None:
        ...
        log_return = trade_ledger.mean_log_return(window_nanos=window_nanos)
        ...
        with super().message_sender.create(type=MeanTradeLogReturnMsg) as mean_trade_log_return_msg:
            mean_trade_log_return_msg.signal_id = subscription.signal_id
            mean_trade_log_return_msg.last_trade_time_nanos = trade_ledger.latest_time
            mean_trade_log_return_msg.log_return = log_return
            mean_trade_log_return_msg.gradient = signal_memo.gradient() or DEFAULT_GRADIENT
            super().message_sender.send(msg=mean_trade_log_return_msg)